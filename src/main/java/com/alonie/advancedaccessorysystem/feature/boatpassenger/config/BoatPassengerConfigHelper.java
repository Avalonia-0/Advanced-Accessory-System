...
public final class BoatPassengerConfigHelper {
    ...
    public static final String DEFAULT_ADDED_BOAT_IDS_JSON =
            "[\"*_boat\",\"*_raft\",\"minecraft:minecart\"]";
    ...
    public static Set<String> parseAddedBoatPatterns(String rawJson) {
        return parseStringArray(rawJson, DEFAULT_ADDED_BOAT_PATTERNS);
    }

    public static Set<String> parseAddedSaddlePatterns(String rawJson) {
        return parseStringArray(rawJson, DEFAULT_ADDED_SADDLE_PATTERNS);
    }
