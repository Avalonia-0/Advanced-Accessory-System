...
public final class BoatPassengerSettingsSyncClient {
    ...
    private static void syncLocalSettings(Minecraft client) {
        ...
        new BoatPassengerSettingsRequestPayload(
                radius,
                boatAutoPickUpJson,
                addedBoatIdsJson,
                addedSaddleIdsJson,
    ...
    private static void applyLocalAccessoryPatterns() {
        AccessoryPatternRuntimeState.setAddedBoatPatterns(BoatPassengerWhitelistConfig.getAddedBoatRules());
        AccessoryPatternRuntimeState.setAddedSaddlePatterns(BoatPassengerWhitelistConfig.getAddedSaddleRules());
    }
