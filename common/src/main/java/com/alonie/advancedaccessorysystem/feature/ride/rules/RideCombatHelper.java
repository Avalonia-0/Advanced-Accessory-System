...
public final class RideCombatHelper {
    ...
    public static boolean shouldTrimPassengerHitbox(Entity entity) {
        ...
        // ServerPlayer can recalculate its bounding box during construction,
        // before spectator/network state has been initialized.
        return player.getVehicle() instanceof Player;
    }

    public static AABB trimPassengerHitbox(AABB box) {
        ...
        return new AABB(box.minX, box.minY + cutoff, box.minZ, box.maxX, box.maxY, box.maxZ);
    }

    public static AABB getPassengerCollisionBox(Entity entity, AABB originalBox) {
    ...
    public static boolean isRidePair(Player attacker, Entity target) {
